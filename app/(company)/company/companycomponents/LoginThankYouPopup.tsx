...
export default function LoginThankYouPopup({
  open,
  employeeName,
  loginTime,
  onClose,
  ...
  return (
    <div className="fixed inset-0 bg-black/40 z-50 flex justify-center pt-30">
      <div className="bg-white w-full max-w-[250px] rounded-sm h-[250px] p-5 shadow-xl text-center relative">
        <h3 className="text-lg font-bold text-teal-700 mb-2">Welcome!</h3>
