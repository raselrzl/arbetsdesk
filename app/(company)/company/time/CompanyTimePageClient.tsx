...
export default function CompanyTimePage({ company }: { company: Company }) {
  ...
  const organizationNo = company?.organizationNo ?? "";
...
">
  ...
  <div>
    ...
    <div>Org No: ${organizationNo}</div>
  </div>

  <!-- RIGHT: Print info -->
  <div style="text-align: right;">
    <div style="font-weight: bold;">Time Report</div>
          ...
          <div className="bg-white w-full max-w-3xl my-10 p-6 relative">
            ...
            <div className="mb-4 flex justify-between items-start px-10 pt-5">
              ...
              <div className="text-sm text-gray-700 text-right">
                <div className="font-medium">Time Report</div>
