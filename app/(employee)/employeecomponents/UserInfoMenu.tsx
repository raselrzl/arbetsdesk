    ...
    <Sheet>
      ...
      <SheetContent side="right" className="w-80 p-6">
        <SheetHeader className="mb-4">
          <SheetTitle className="text-lg font-bold">User Information</SheetTitle>
        </SheetHeader>
          ...
          {user ? (
            <div className="bg-teal-50 p-4 rounded-lg shadow-sm border border-teal-100">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="font-semibold text-teal-900">{user.name || "Employee"}</p>
              ...
              <div className="mt-3 border-t border-teal-100 pt-3 text-sm text-gray-700 space-y-1">
                {user.personalNumber && (
                  <p>
                    <span className="font-semibold">Personal Number:</span> {user.personalNumber}
                  </p>
                )}
                {user.email && (
                  <p>
