  ...
  return (
    <main className="bg-white">
      ...
      <section className="max-w-7xl mx-auto px-4 py-24 flex flex-col md:flex-row items-center gap-12">
        {/* IMAGE */}
        <motion.div
          initial={{ opacity: 0, x: 40, scale: 0.95, rotateZ: 0 }}
          whileInView={{ opacity: 1, x: 0, scale: 1.2, rotateZ: 0 }}
          viewport={{ once: true }}
        ...
        >
           <h2 className="text-xl font-semibold text-[#00687a]">
          ...
          <p className="text-[#00687a] text-sm md:text-lg leading-relaxed text-justify">
            ...
            update, swap, or delete schedules in just a few clicks. Plan weekly
            or monthly schedules for your entire staff all in one place.
          </p>
        </motion.div>
      </section>
            ...
            return (
              ...
              >
                ...
                >
                  ...
                  {/* DESKTOP OVERLAY */}
                  <div
                    className={`hidden md:block absolute top-10 ${"right-[-380px]"} max-w-xl bg-white/90 backdrop-blur-md p-6 rounded-2xl shadow-lg`}
                  >
