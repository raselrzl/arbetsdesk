        ...
        <div className="max-w-7xl mx-auto h-full px-4 grid grid-cols-1 md:grid-cols-2 items-center gap-12">
          ...
          >
            ...
            <h2 className="text-xl font-semibold mb-4 text-gray-800">
              Smarter Operations for Hospitality Teams
            </h2>

            <p className="text-gray-700 text-lg leading-relaxed">
              Arbetsdesk helps hotels manage staff scheduling, working hours,
              payroll, and performance with ease. From front desk to
              housekeeping, all employee time is tracked automatically, ensuring
              accurate payroll and full visibility across departments. Reduce
              administrative work and keep daily operations running smoothly.
            </p>
          </motion.div>
      ...
      <section className="relative bg-[#02505e] text-center">
        ...
        <div className="relative z-10 py-24 px-4">
          ...
          <p className="text-teal-500 mb-8 max-w-xl mx-auto">
            Unlock the full potential of your business with Arbetsdesk
            analytics.
          </p>
