          ...
          >
            ...
            <div className="w-full md:w-[620px] relative">
              ...
              <div className="md:hidden absolute bottom-0 left-1/2 -translate-x-1/2 translate-y-[90%] w-[90%] bg-white/90 backdrop-blur-md p-5 rounded-2xl shadow-lg text-center z-10">
                ...
                <h2 className="text-base font-semibold mb-2 text-gray-800">
                  Built for Fast-Paced Hospitality Teams
                </h2>

                <p className="text-gray-700 text-sm leading-relaxed">
                  Manage schedules, hours, tips, payroll, and performance in one
                  automated system designed for busy restaurant teams.
                </p>
              </div>
            </div>
            ...
            <div className="hidden md:block absolute -bottom-40 right-[-300px] max-w-md bg-white/90 backdrop-blur-md p-6 rounded-2xl shadow-lg">
              ...
              <p className="text-gray-700 text-base leading-relaxed">
                Manage schedules, working hours, tips, payroll, and performance
                in one system. Arbetsdesk automates time tracking and
                calculations so your team can focus on service—not admin work.
              </p>
            </div>
          </motion.div>
        </div>
      ...
      <section className="relative bg-[#02505e] text-center">
        ...
        <div className="relative z-10 py-24 px-4">
          ...
          <p className="text-teal-400 mb-8 max-w-xl mx-auto">
            See how Arbetsdesk helps restaurants save time, reduce costs,
            and manage teams efficiently.
          </p>
